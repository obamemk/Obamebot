    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            try {
                ...
                const chatId = '24174769169@s.whatsapp.net';
                const imagePath = './database/ObameBot.jpg';
                ...
                const messageText = `
╔════════════════════════════╗
      *ObameBot Connected Successfully* 🤖
╚════════════════════════════╝

> "Always Forward. ObameBot, your WhatsApp assistant."
